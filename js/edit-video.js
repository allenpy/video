nimbus_screen.editVideoInit = function () {
    ...
    let $nsc_video_button_crop = $('#nsc_video_button_crop');
    ...
    $nsc_video_button_crop.on('click', function () {
        console.log('Crop', start_crop_lost / zoom_range, 'to', finish_crop_lost / zoom_range);
    });
