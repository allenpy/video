...
nimbus_screen.editDoneInit = function () {
    ...
    $('#nsc_connect_to_google').on('click', function (e) {
        ...
        window.open('https://www.bokecc.com/auth/openidconnect.php?env=app&provider=google', '_blank');
        return false;
    });

    $('#nsc_connect_to_facebook').on('click', function (e) {
        $('#nsc_popup_connect_nimbus').hide();
        window.open('https://www.bokecc.com/auth/openidconnect.php?env=app&provider=facebook', '_blank');
        return false;
    });
